...
const NAV: NavItem[] = [
  ...
  { href: "/admin/room-sizes", label: "Room Sizes", icon: <Ruler className="size-5" />, adminOnly: true },
  { href: "/admin/mina-tiers", label: "Mina Tiers", icon: <Tent className="size-5" />, adminOnly: true },
